...
public class UserRepository extends Repository {
     ...
     */
    public void getPrivateProfile(MutableLiveData<Boolean> success) {
        ...
        result.enqueue(new Callback<JsonElement>() {
            ...
            public void onResponse(@NotNull Call<JsonElement> call, @NotNull Response<JsonElement> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    body.add("settings", JsonParser.parseString(body.get("settings").getAsString()).getAsJsonObject());

                    LoggedInUser loggedInUser = gson.fromJson(body.getAsJsonObject(), LoggedInUser.class);
